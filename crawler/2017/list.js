...
const list_path = path.resolve(__dirname, "..", "..", "data", "2017", "list.json");
...
async function crawl() {
    ...
    const base_URL = "https://ithelp.ithome.com.tw/2017ironman/";
    const types = ["web", "devops", "cloud", "big_data", "security", "self"];
